...
//
// General
// - easy_gui is a low-level GUI system where there are no "controls", but instead generic objects referred to as elements.
...
//   referred to as inbound events. An event that is generated by easy_gui (and handled by easygui_next_event() and
//   easygui_handle_event()) are referred to as outbound events.
...
//   rationale for this is because storing it as relative complicates absolute positioning calculations because it would
